<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                @if(!request()->header('User-Agent') || !Str::contains(request()->header('User-Agent'), ['Mobile','Android','iPhone']))
                    @if($user->id_level == 1)
                        ...
                        <x-nav-link :href="route('capture')" :active="request()->is('capture')">
                            Capture
                        </x-nav-link>&nbsp;&nbsp;
                        <x-nav-link :href="route('mcu.index')" :active="request()->is('mcu')">
                            Data Image
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @if($user->id_level == 1)
            ...
            <x-responsive-nav-link :href="route('capture')" :active="request()->is('capture')">
                Capture
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('mcu.index')" :active="request()->is('mcu')">
                Data Image
            </x-responsive-nav-link>
